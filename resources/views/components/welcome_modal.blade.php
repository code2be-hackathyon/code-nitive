    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Comment Reflex'Yon fonctionne ?</h4>
            ...
            <div class="modal-body">
                ...
                <h5>Quizz terminé <i class="fas fa-check" style="margin-right: 7px;color:#27ae60"></i></h5>
                <h5>L'écart de temps entre chaque répétition augmentera après chaque validation.</h5>
                <h5>Vous pouvez aussi ajouter des amis afin de comparer vos résultats sur les différents quizz.</h5>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
